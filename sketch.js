...
function setup() {
    ...
    rect1 = Bodies.rectangle(width / 2, 680, 100, 20, {isStatic:true} );
	rect2 = Bodies.rectangle(350, 680, 20, 100, {isStatic:true} );
	rect3 = Bodies.rectangle(450, 680, 20, 100, {isStatic:true} );
